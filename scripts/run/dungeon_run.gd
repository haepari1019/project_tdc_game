...
const Chest := preload("res://scripts/world/chest.gd")
...
const Trap := preload("res://scripts/world/trap.gd")
const Lever := preload("res://scripts/world/lever.gd")
const Barrel := preload("res://scripts/world/barrel.gd")
...
const Torch := preload("res://scripts/world/torch.gd")
