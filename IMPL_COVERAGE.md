...
- **P4b 이관 진행:** M0 데이터위생 · M0b 결속키 · M1 마석 · M2 참 · **CS-1 Passive폐기/참일원화** · **CS-2 F-030 doctrine(골격+Trait 런타임)** 완료. 다음 = **CS-3 F-005 §3.3a NC 변조**. 작업 지시서 [docs/plan/P4b_WORK_ORDER.md](docs/plan/P4b_WORK_ORDER.md) §6.5.
