...
- **P4b 이관 진행:** M0 데이터위생 · M0b 결속키 · M1 마석 · M2 참 · **CS-1 Passive폐기/참일원화** 완료. 다음 = CS-2 F-030 doctrine 골격(선행: QA-032 §2.1 기준선 스냅샷) → CS-3 F-005 §3.3a. 작업 지시서 [docs/plan/P4b_WORK_ORDER.md](docs/plan/P4b_WORK_ORDER.md).
