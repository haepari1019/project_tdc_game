...
> **`PENDING-PROP` 1건** — 모딩 시술비의 가격 축·게이트가 `F-008` §3.10 「재구매」의 의도와 맞는지.
...
| 6 | **DRIFT-152** 모딩 시술비 — `F-008` §3.10 「동일 AB 재구매」의 구체화(가격 축 = 구 생본가 승계 · `scribe_shop` tier 게이트) | `F-008` §3.10 · `F-009` §3.9.3 | ⏳ **`PENDING-PROP`** — M6 착수 전 |
