...
| **P2-S5b** ✅ | Encounter Variety 엔진(조합 제너레이터·창발 모디파이어·런 내 비복원) + EN-* 정식 태그 | S5a · EN-* 태그 | M–L | ✅ |
| **P2-S6b** ✅ | economy/UI + gear roll-table (per-AB tier·potencyMult·multi-affix 포함) | hub | M–L | ✅ |
| **P2-S7** ✅ | 통합 회귀/QA (QA-021/029 헤드리스·F5 체크리스트·역전파) | 전부 | M | ✅ |
...
### P2-S6b — economy/UI + gear roll-table ✅ (완료 2026-06-26)
...
> **P2 완료 후 잔여·이연 전체 대장 → [BACKLOG_open_items.md](BACKLOG_open_items.md)** (T1 지금가능 ~ T5 Expansion, 출처 교차검증·2026-07-04).
