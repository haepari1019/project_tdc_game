...
> **2026-08-24 추가:** 맵 고도화 **Phase 1 전파 패킷 초안** = [`_PROP_PACKET_MAP_PHASE1.md`](_PROP_PACKET_MAP_PHASE1.md) (A `routeClass` · B **경로·레이어가 교전 티어 공급**(택일) · C `spatialGrammar` · D `encounterAnchor.category` · E `lootAnchor.tier` · F 신규 ID). 🕒 **미집행 — §B 택일 + §F 명명 판정 대기.** Phase 0(DRIFT-162~166)은 전부 게임 소유라 전파 대상 아님.
>
