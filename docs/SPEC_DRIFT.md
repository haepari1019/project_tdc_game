...
### DRIFT-196 — 시전선은 대상에 붙는다: 단일 대상 접근 점선 추종 + 색 분기 + 조준 표식 🔷 Phase 2 · 전파 불요
...
### DRIFT-197 — 표식은 스킬이 나갈 때까지 남는다: 시전 구간 조준 표식 🔷 Phase 2 · 전파 불요
...
### DRIFT-198 — 표적이 작지 조준이 나쁜 게 아니다: 단일 대상 관대 선택 🔷 Phase 2 · 전파 불요
...
### DRIFT-199 — 술어가 이름값을 못 했다: 채널 중 진형 추종에 끌려가 스스로 채널을 끊던 문제 🔷 Phase 2 · 전파 불요
