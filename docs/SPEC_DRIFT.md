...
- **분류\전파:** **impl(아키텍처).** 규칙 드리프트 없음. **Rampart 투사체흡수(DRIFT-057 BLOCKED) → 부분 해소**: projectile-delivery 어빌리티가 시전자↔표적 사이 **적대** Rampart/벽에 맞으면 흡수·차단(현재 AB-056만). threat-on-hit은 후속.
